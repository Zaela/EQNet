...
#define EQNET_BUFF_COUNT 25
#define EQNET_DISCIPLINE_COUNT 100
#define EQNET_SPELLBOOK_COUNT 480
#define EQNET_MEMSPELL_COUNT 9
#define EQNET_LANGUAGE_COUNT 28
#define EQNET_GROUP_LEADERSHIP_COUNT 16
#define EQNET_RAID_LEADERSHIP_COUNT 16
#define EQNET_TOTAL_LEADERSHIP_COUNT 32
#define EQNET_BIND_POINT_COUNT 5
#define EQNET_EQUIP_MATERIAL_COUNT 9
#define EQNET_EQUIP_TINT_COUNT 7
#define EQNET_AA_COUNT 240
#define EQNET_SKILL_COUNT 100
#define EQNET_BANDOLIERS_COUNT 20
#define EQNET_BANDOLIER_ITEMS_COUNT 4
#define EQNET_POTION_BELT_ITEM_COUNT 5
#define EQNET_TRIBUTE_COUNT 5
...
enum EQNet_MaterialSlot
{
	EQNET_MATERIAL_Primary = 7,
	EQNET_MATERIAL_Secondary
};
